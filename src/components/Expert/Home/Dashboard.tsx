...
const Dashboard = () => {
  ...
  const { serviceName, notes, userData, distance, totalAmount, ratePerHour } = serviceRequest || {};
            ...
            <div className="w-full max-w-3xl bg-white rounded-lg shadow-lg p-6 border border-gray-200">
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex items-center">
                  ...
                  <div className="space-y-1">
                    <p className="text-gray-800 text-lg font-semibold">Name: {userData?.name}</p>
              ...
              <div className="space-y-2 mb-4 p-4 bg-indigo-100 rounded-lg flex justify-between items-center">
                <div className="flex-1 font-semibold">
                  ...
                  <p className="text-gray-800 p-1">Distance: {distance?.toFixed(4)} km</p>
                </div>

                {/* Price Display */}
                <div className="flex flex-col items-end">
                  <div className="text-4xl font-bold text-gray-800 pr-5">₹{totalAmount?.toFixed(2)}</div>
              ...
              <div className="text-center mt-4">
                  <p className="text-sm text-red-500">*Refreshing the page will clear the current request and it cannot be recovered. </p>
                </div>
            </div>
          </div>
        </>
      ) : (
        <div className="text-center py-4">No service requests at the moment.</div>
      )}
    </div>
  );
};
