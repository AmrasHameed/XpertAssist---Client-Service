  ...
  {otpPage ? (
    ...
    <div className="min-h-screen flex flex-col md:flex-row items-center justify-between px-6 md:px-10">
      ...
      <div className="w-full md:w-1/2 space-y-4 md:space-y-6">
        ...
        <h2 className="text-2xl font-semibold text-center md:text-left">Expert Sign Up</h2>
        ...
        <form onSubmit={formik.handleSubmit}>
            ...
            >
              <span className="flex-2">
                {formik.values.service
                  ? services.find((service) => service._id === formik.values.service)?.name
            ...
            {isOpen && (
              <ul className="absolute w-full bg-white border border-gray-300 rounded mt-1 z-10">
                {services.map((service) => (
                  ...
                  >
                    {service.name}
                    <Tooltip id={`tooltip-${service._id}`} className="bg-gray-700 text-white">
                      {service.description}
                    </Tooltip>
                  </li>
                ))}
          ...
          <div className="relative mb-4">
            <input
              ...
              id="image"
              name="image"
              onChange={(e) => handleFileChange(e, 'image', setImageUrl, formik)}
